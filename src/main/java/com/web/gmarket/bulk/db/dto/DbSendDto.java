...
public class DbSendDto {
	...
	// 조회 컬럼
	@NotBlank(message = "요청번호를 조회 후 지정하세요.", groups = NotBlankGroup7.class)
	...
	// 등록 조건
	@NotBlank(message = "메시지 분류를 선택하세요.", groups = NotBlankGroup1.class)
	...
	// 메시지 내용
	@NotBlank(message = "메시지를 입력하세요.", groups = NotBlankGroup4.class)
	...
	// SMS 수신여부
	@NotBlank(message = "SMS 수신여부를 선택하세요.", groups = NotBlankGroup6.class)
